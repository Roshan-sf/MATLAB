...
[Pdec1, I_adjusted, I_adjusted2] = IVCurve(group1,1);

[Pdec2, I_adjusted, I_adjusted2] = IVCurve(group2,2);

[Pdec3, I_adjusted, I_adjusted2] = IVCurve(group3,3);

[Pdec4, I_adjusted, I_adjusted2] = IVCurve(group4,4);
...
function [Pdec, I_adjusted, I_adjusted2] = IVCurve(dataS,groupNum)
