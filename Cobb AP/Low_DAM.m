...
% Convert control1 variables to percent (100% = max value in vector)
timeCP         = (timeC         ./ 60);
...
% Convert control2 variables to percent
timeC2P         = (timeC2         ./ 60);
...
% Convert reflash1 variables to percent
timeRP         = (timeR         ./ 60);
...
% Convert reflash2 variables to percent
timeR2P         = (timeR2         ./ 60);
...
figure('Name','Control Driving Data 3')
